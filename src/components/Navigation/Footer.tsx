            ...
            <div className="font-[Noto_Sans] flex flex-wrap flex-row flex-[0.5] justify-around items-start">
                ...
                <div className="flex-10 m-4 min-w-[80px]">
                    ...
                    <ul className="text-xl list-none p-0">
                        <li className="mb-2"><a href="/resources/student" className="hover:text-[#f8d6ba] transition-colors">Student Resources</a></li>
                        <li className="mb-2"><a href="/resources/rso" className="hover:text-[#f8d6ba] transition-colors">RSO Resources</a></li>
